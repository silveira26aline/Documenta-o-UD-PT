...
\subsection{Números compostos}

	Números compostos podem conter \textit{upos} \say{NUM}, \say{CCONJ} e \say{ADP}. Quando o número composto modifica um substantivo, o primeiro número deve se subordinar ao substantivo como \say{nummod}; quando há um sintagma preposicionado, o primeiro número do número composto será o \textit{head}, e o substantivo, \say{nmod} do número. Além disso, deve-se notar que o primeiro número deve receber os \textit{misc} \say{MWE} e \say{MWEPOS}.
